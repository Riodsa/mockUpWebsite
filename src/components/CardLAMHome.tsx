...
const CardLifeAtMitrphol = ({
  ...
  return (
    <motion.div
      className={`flex flex-col rounded-2xl z-2 absolute overflow-hidden ${className} cursor-default`}
      variants={variant}
    ...
    >
      ...
      <motion.div
        className={`absolute top-4/5 inset-0 rounded-b-2xl overflow-hidden h-2/5 w-auto flex flex-col pl-4 bg-${color ? (color + '-500') : "white"}`}
